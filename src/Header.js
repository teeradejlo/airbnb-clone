...
function Header() {
    ...
    return (
        <div className = "header" id="home-header" style = {{backgroundColor: headerColor, height: headerHeight}}>
                <div className="header_left">
                    <img  alt="logo" src={logoColorWhite ? Logo_white : Logo_red}/>  
                </div>
                <div className="header_middle">
                    <div className="header_mode" style={{color: textColor, transform: `scale(${inputTabSize})`, position: inputTabPos}}>
